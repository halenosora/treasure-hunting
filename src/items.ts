...
export const LOCAL_ITEMS: Item[] = [
  ...
  { id: 'kyoto_kasa',       name: '舞妓の傘',            category: 'アクセサリー', rarity: 'エピック', emoji: '☂️', description: '京都祇園限定の和傘',           source: '京都府・祇園エリア' },
  ...
  { id: 'hokkaido_fur',     name: '北海道ファーコート',   category: '上着',        rarity: 'エピック', emoji: '🧤', description: '北海道の冬限定コート',         source: '北海道・札幌エリア' },
];

// 企業コラボアイテム
export const COLLAB_ITEMS: Item[] = [
  { id: 'nike_shoes',      name: 'NIKEエアマックス',       category: '靴',          rarity: '限定',   emoji: '👟', description: 'NIKE購入者限定デジタルシューズ', source: 'NIKE直営店' },
  { id: 'adidas_shoes',    name: 'ADIDASスタンスミス',     category: '靴',          rarity: '限定',   emoji: '👟', description: 'ADIDAS購入者限定',             source: 'ADIDAS直営店' },
